<script lang="ts">
	...
	const navItems = [
		...
		{
			href: '/inventur',
			label: 'nav.stocktake' as MessageKey,
		...
		{
			href: '/artikel',
			label: 'nav.items' as MessageKey,
			// Heroicons: cube
			icon: 'M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9'
		},
		{
			href: '/rezepte',
			label: 'nav.recipes' as MessageKey,
			// Heroicons: book-open
			icon: 'M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25'
		},
		{
			href: '/bestellen',
			label: 'nav.order' as MessageKey,
	...
	<div class="min-h-dvh bg-gray-50 text-gray-900 md:flex">
		...
		<div class="flex min-h-dvh flex-1 flex-col">
			...
			>
				...
				<a href="/scan" aria-label={t('nav.scan')} class="relative -top-3 flex flex-1 flex-col items-center">
